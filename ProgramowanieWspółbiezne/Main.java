...
class Parking {
    ...
    // Semafor sterujący dostępem do miejsc parkingowych
    private Semaphore semaphore;

    public Parking(int capacity) {
        this.capacity = capacity;
        // Inicjalizujemy semaphor z liczbą zezwoleń równą pojemności parkingu
        this.semaphore = new Semaphore(capacity);
    }

    public void enter() throws InterruptedException {
        // Samochód czeka (blokuje się), jeśli na parkingu nie ma wolnych miejsc
        semaphore.acquire();
    ...
    public void leave() {
        ...
        // Samochód opuszcza parking i zwalnia miejsce dla kolejnych oczekujących
        semaphore.release();
    }
}
